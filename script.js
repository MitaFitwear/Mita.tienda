const productos = [
    ...
    { id: 5, nombre: "Térmica black", precio: 14868, imagenes: ["img/termicablack.png", "img/termicadetalles.png"], tela: "algodón.", talles: ["2"] },
    ...
    { id: 17, nombre: "Manga corta ink", precio: 13520, imagenes: ["img/mangacortaink.png", "img/mangacortainkdetalles.png"], tela: "Modal y algodón.", talles: ["talle único"] },
    { id: 18, nombre: "Manga corta nude", precio: 13520, imagenes: ["img/mangacortanude.png", "img/mangacortanudedetalles.png"], tela: "Modal y algodón.", talles: ["talle único"] }
];
...
function finalizarCompra() {
    ...
    window.open(`https://wa.me/543388411810?text=Hola! Quiero realizar un pedido:%0A${texto}%0A%0ATOTAL: $${total}`);
}
